...
echo "  5. Import workflow: n8n/workflows/job-scraper-automation.json (API) or n8n/workflows/job-scraper-direct-import.json (direct command + import)"
echo "  6. Set PORTAL_URL for n8n to http://host.docker.internal:4321 (not localhost)"
